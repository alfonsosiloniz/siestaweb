...
public class EjecutorAgenteReceptor extends Thread
{
                ...
                if (sourceFilePC != null) {
                    ...
                    if (file.exists()) {
                        try {
                            ...
                            // Antes de lanzar la compresion del video, comprobamos si hay otro video comprimiendos y lo matamos.
                            finalizarProcesoActual();
                    ...
                    // No se ha configurado la unidad PCn en el fichero de properties
    ...
    private void finalizarProcesoActual() {
        if (AgenteReceptor.getRunningProcess() != null /*&& 
            AgenteReceptor.getRunningProcess().getEstado() == ScriptLauncher.ESTADO_RUNNING*/) 
        {
