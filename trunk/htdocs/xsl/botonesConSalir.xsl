...
<xsl:template name="BARRA_BOTONES">
	<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
		<tr height="64">
			...
			<td class="borderBotones" align="center">
				<a href="/cgi-bin/box/configSIESTA"           title="Configuración SIESTA"          style="text-decoration:none;"><img src="/img/configSIESTA.gif" width="32" height="32" border="0" alt="Configuración SIESTA"/>         <br/>SIESTA</a>
			</td>
			<td class="borderBotones" align="center">
