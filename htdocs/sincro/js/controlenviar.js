...
function capaTrans(){
  ...
  mensajeTapa.style.backgroundImage = 'url("/sincro/img/capa6.gif")';
...
function mostrarMensajeProceso(){  
  ...
  mensajeProceso.style.backgroundImage = 'url("/sincro/img/recuadro_procesando.gif")';
  textoProceso = "PROCESANDO";
  textoProceso = "<table width=100% height='70px' border=0 cellpadding=0 cellspacing=0><tr><td><table width=100% height='45px' border=0 cellpadding=0 cellspacing=0 ><tr><td align='center' style='font-family:Arial, Helvetica, sans-serif; color:#FF0000; font-weight:bold; font-size:15px'>" + textoProceso + "</td></tr><tr><td align='center'><img src='/sincro/img/ajax-loader.gif'></td></tr></table></td></tr></table>";
