...

{
	...
	if ( FNR > 1 ) {
		...
		if ( FNR == lin_bloque ) {
			...
			if ( sint <= 3 ) {
				# Linea separador
				printf("\t\t\t\t\t\t<tr><td colspan=\"6\" class=\"titTabla\" height=\"4\"></td></tr>\n")
				printf("\t\t\t\t\t\t<tr><td colspan=\"6\" class=\"titTabla\" height=\"1\" bgcolor=\"#000000\"></td></tr>\n")
				printf("\t\t\t\t\t\t<tr><td colspan=\"6\" class=\"titTabla\" height=\"4\"></td></tr>\n")
				if ( sint < 3 ) {
					# Encabezado sintonizador
					printf("\t\t\t\t\t\t<tr><td colspan=\"6\" class=\"titTabla\">Sintonizador %i (%i grabaciones)</td></tr>\n",sint,nRecs)
					printf("\t\t\t\t\t\t<tr><td colspan=\"6\" class=\"titTabla\" height=\"4\"></td></tr>\n")
				} else {
					# Encabezado detalle
					printf("\t\t\t\t\t\t<tr><td colspan=\"6\" class=\"titChannel\">Detalle Grabaciones (%i grabaciones)</td></tr>\n",nRecs)
					printf("\t\t\t\t\t\t<tr><td colspan=\"6\" class=\"titTabla\" height=\"4\"></td></tr>\n")
					printf("\t\t\t\t\t\t<tr><td colspan=\"6\" class=\"titTabla\" height=\"4\"></td></tr>\n")
					printf("\t\t\t\t\t</table>\n")
					printf("\t\t\t\t\t<table width=\"100%%\" border=\"1\" bordercolor=\"#000000\" cellpadding=\"2\" cellspacing=\"0\" bgcolor=\"#FFEEE6\">\n")
					printf("\t\t\t\t\t\t<tr class=\"titTabla\">\n")
